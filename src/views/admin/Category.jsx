...
<div className='flex lg:hidden justify-between items-center mb-5 p-4 bg-[#6a5fdf] rounded-md'>
    ...
    <button onClick={() => setShow (true)} className='bg-red-500 shadow-lg hover:shadow-red-500/40 px-4 py-2 cursor-pointer text-white rounded-sm text-sm'>Add</button>
      ...
      <div className="flex flex-wrap w-full">
        ...
        <div className={`w-[320px] lg:w-5/12 translate-x-100 lg:relative lg:right-0 fixed ${show ? 'right-0' : '-right-[340px]'} z-[9999] top-0
            ...
            <div className='bg-[#6a5fdf] h-screen lg:h-auto px-3 py-2 lg:rounded-md text-[#d0d2d6]'>
                ...
                <form >
                         <div className='flex flex-col w-full gap-1 mb-3'>
                            ...
                            <input className='px-4 py-2 focus:border-indigo-500 outline-none bg-[#f0f0f1] border border-slate-700 rounded-md text-[#0d0d0e]' 
                            type='text' id='name' name='category_name' placeholder='Category Name'></input>

                         </div>
                         <div>
                            <label className='flex justify-center items-center flex-col h-[238px] cursor-pointer border border-dashed
                             hover:border-red-500 w-full border-[#d0d2d6]'
                             htmlFor='image' >
                                <span><FaImage/></span>
                                <span>Select Image</span>
                             </label>
                             <input className='hidden' type='file' name='image' id='image'></input>
                             <div >
