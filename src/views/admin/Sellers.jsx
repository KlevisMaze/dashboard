          ...
          <table className="w-full text-sm text-left  text-[#d0d2d6]">
            <thead className="text-sm text-[#d0d2d6] uppercase border-b border-slate-700">
              <tr>
                ...
                <th scope="col" className="py-3 px-4">Discrict</th>
            ...
            <tbody>
              {
                ...
                <td scope="row" className="py-1 px-4 font-medium whitespace-nowrap">Klevis</td>
                <td scope="row" className="py-1 px-4 font-medium whitespace-nowrap">Atra Albania</td>
                <td scope="row" className="py-1 px-4 font-medium whitespace-nowrap"><span>Pending</span></td>
                <td scope="row" className="py-1 px-4 font-medium whitespace-nowrap">klevis.maze@gmail.com</td>
                <td scope="row" className="py-1 px-4 font-medium whitespace-nowrap">Tirana</td>

                <td scope="row" className="py-1 px-4 font-medium whitespace-nowrap">Myslym Shyri</td>
